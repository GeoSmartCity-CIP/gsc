...
/**
 * ThermalzoneEnergyamountTId generated by hbm2java
 */
@Embeddable
public class ThermalzoneEnergyamountTId implements java.io.Serializable {
	...
	public ThermalzoneEnergyamountTId() {
	}
	
	public ThermalzoneEnergyamountTId(String uuid, double energyamountEAmount, String energyamountESource,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ThermalzoneEnergyamountTId))
			return false;
		ThermalzoneEnergyamountTId castOther = (ThermalzoneEnergyamountTId) other;
