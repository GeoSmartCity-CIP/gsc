...
public class ProjectPropertiesSolar {
	
	private static Logger LOGGER = Logger.getLogger(ProjectPropertiesSolar.class);
	private static Properties properties;
	private static Properties messages;
	
	private static Properties readFromConfig() {
		InputStream inputStream = ProjectPropertiesSolar.class.getClassLoader().getResourceAsStream("config.properties");
	...
	private static Properties readFromMessages() {
		InputStream inputStream = ProjectPropertiesSolar.class.getClassLoader().getResourceAsStream("messages.properties");
